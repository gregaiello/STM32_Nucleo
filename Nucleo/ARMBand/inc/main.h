...
#define SLAVE_ADDRESS ((uint32_t) 0xA)
#define MASTER_ADDRESS ((uint32_t) 0x1)
#define I2CFMP_TIMING ((uint32_t) 0x0020081F)
#define TIMING_CLEAR_MASK      (0xF0FFFFFFU)

const uint32_t SLAVE_ADDRESS_CR2 = (SLAVE_ADDRESS << 1);
const uint32_t MASTER_ADDRESS_OAR1 = (MASTER_ADDRESS << 1);
const uint16_t LEDS = GPIO_Pin_7 | GPIO_Pin_14 | GPIO_Pin_0;
const uint16_t LED[3] = {GPIO_Pin_7, GPIO_Pin_14, GPIO_Pin_0};
const uint16_t I2CFMP_SDA_SCL = GPIO_Pin_14|GPIO_Pin_15;
